...
docker run -d \
  ...
  ghcr.io/justprosound/zabbix-proxy-sqlite3-av-edition-av-edition-av-edition:latest
```
...
services:
  zabbix-proxy:
    image: ghcr.io/justprosound/zabbix-proxy-sqlite3-av-edition-av-edition-av-edition:latest
